...
<form action="addUser" style="border:1px solid #ccc" method="post">
  <div class="container">
    ...
    <label for="user_mobile"><b>Mobile</b></label>
    <input type="text" placeholder="Enter Last Name" name="user_mobile" required>
    ...
    <input type="text" placeholder="Enter Mobile" name="confirm_password" required>
